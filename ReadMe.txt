...
TODO:
1. Написать пятнашки;
2. Написать 2048 (https://play2048.co/);

DONE:
Отобразить XML файл в виде таблицы;
...
DONE:
Написать тест на 5 вопросов, и обеспечить подсчет правильных ответов;

TODO:
1. Написать coutdown timer, который вычисляет количество секунд, минут, дней, недель, месяцев и лет до указанной даты;	DONE
2. Если выбранная пользователем точка времени прошла, то программа считает сколько времени прошло от этой точки;		DONE
3. Должны отображаться только актуальные элементы времени;
4. По достижении точки времени должен зазвонить будьльник;
